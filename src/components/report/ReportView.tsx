...
export default function ReportView({ extracted, scored, dealId, saving, onBack, onNew, sampleMode }: {
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media print {
          ...
          /* Keep the score ring and dimension cards visible */
          .report-hero,
          .report-metrics,
          .report-content {
            display: block !important;
          }
          /* Avoid splitting dimension cards across pages */
          .dimension-card,
          [class*="DimensionRow"],
          [data-dimension-row] {
          ...
          /* Report footer with generation date — populated via data-date attr */
      ...
      <header className="report-header" style={{
        ...
        <div className="report-header-right" style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              background: 'none', border: '1px solid rgba(0,180,160,0.35)',
              borderRadius: 6, padding: '5px 12px', color: '#00b4a0',
      ...
      {/* ── MAIN CONTENT ── */}
      <div
        className="report-content report-print-footer"
        data-print-footer={`Generated by Acquira · ${new Date().toLocaleDateString('en-AU')}`}
        style={{ padding: '40px', maxWidth: 1200 }}
      >
