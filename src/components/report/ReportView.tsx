    ...
    <div style={{
      ...
      <div className="report-content" style={{ padding: '40px', maxWidth: 1200 }}>
          ...
          {demographics !== null && (
            <div style={{ background: '#112236', border: '1px solid #1e3a5f', borderRadius: 8, padding: 20 }}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 16 }}>
                <div>
                  <div style={{ fontSize: 10, color: '#94a3b8', fontFamily: "'DM Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>0-4 Pop Trend</div>
                  <div style={{ fontSize: 18, fontWeight: 700, fontFamily: "'Space Grotesk', sans-serif", color: demographics.population_0_4.trend === 'declining' ? '#ef4444' : '#00b4a0' }}>
                    {demographics.population_0_4.trend}
                  </div>
                </div>
                <div>
                  <div style={{ fontSize: 10, color: '#94a3b8', fontFamily: "'DM Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>5yr Change</div>
                  <div style={{ fontSize: 18, fontWeight: 700, fontFamily: "'Space Grotesk', sans-serif", color: demographics.population_0_4.pct_change_5yr < 0 ? '#ef4444' : '#22c55e' }}>
                    {demographics.population_0_4.pct_change_5yr > 0 ? '+' : ''}{demographics.population_0_4.pct_change_5yr}%
                  </div>
                </div>
                <div>
                  <div style={{ fontSize: 10, color: '#94a3b8', fontFamily: "'DM Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>Median Income</div>
                  <div style={{ fontSize: 18, fontWeight: 700, fontFamily: "'Space Grotesk', sans-serif", color: '#00b4a0' }}>
              ...
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.2)', fontFamily: "'DM Mono', monospace", marginTop: 12 }}>
                Source: {demographics.source} · Postcode {demographics.postcode} · TODO: ABS Census 2021 SA2 integration
              </div>
            </div>
          )}
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 16, fontWeight: 700, color: '#e8edf3', marginBottom: 8 }}>
            Bull / Bear / Judge Agent Analysis
          </div>
          <div style={{ fontSize: 13, color: '#94a3b8', lineHeight: 1.6, maxWidth: 480, margin: '0 auto 16px' }}>
            Multi-agent AI analysis: one agent argues the bull case, one the bear case, and a judge agent
            adjudicates. Provides a structured second opinion beyond the dimension scoring.
          </div>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.25)', fontFamily: "'DM Mono', monospace" }}>
            TODO: Integrate ~/childcare-copilot — Next.js multi-agent app with Bull/Bear/Judge agents.
            Connect via internal API when ready.
          </div>
        </div>
